...
- :guilabel:`Create Bills and Refunds`: Automatically create a bill/refund when a company confirms
...
To automatically validate the records, select :guilabel:`Validate`. This setting applies to all of
